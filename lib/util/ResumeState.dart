...
abstract class ResumeState<T extends StatefulWidget> extends State<T> with WidgetsBindingObserver {
  ...
  Future<T> pushNamed<T extends Object>(BuildContext context, String routeName, {required Object arguments}) {
    _isPaused = true;
    onPause();
  ...
  /// This method is replacement of Navigator.pushNamed(), but fires onResume() after route popped
  void pop<T extends Object>(BuildContext context, {required Object arguments}) {
    _isPaused = true;
    onPause();
